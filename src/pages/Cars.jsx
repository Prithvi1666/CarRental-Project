...
import CarCarad from '../components/CarCarad'
  ...
  return (
    <div>
      ...
      <motion.div
        ...
        <Title title='Available Cars' subtTitle='Browse our selection of premium vehicles available for your next adventure' />
