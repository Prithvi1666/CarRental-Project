    ...
    <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
        ...
        <div className='lg:col-span-2'>
          <img src={car.image } alt="" className='w-full h-auto md:max-h-130 object-cover rounded-xl mb-6 shadow-md' />
          <div className='space-y-6'>
            ...
            {/* Description */}
            <div>
              <h1 className='text-xl font-medium mb-3'>Descriotion</h1>
             ...
             <div>
              ...
              <ul className='grid grid-cols-1 sm:grid-cold-2 gap-2'>
              {
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500 '>
         ...
         <button className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium
          ...
          <p className='text-center text-sm'>No credit card requird to reserve</p>
        </form>
      </div>
